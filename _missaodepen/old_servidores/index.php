 			...
 			<?php foreach($customers as $customer): ?>
 				<tr>
 					...
 					<td class="actions text-right">
 						...
 						<a href="delete.php?id=<?php echo $customer['id'] ;?>" class="btn btn-sm btn-danger" cata-toggle="modal" data-target="#delete-modal" data-customer="<?php echo $customer['id']; ?>"><i class="fa fa-trash"></i> Excluir</a>
 					</td>
 				</tr>
 			<?php endforeach; ?>
 		<?php else: ?>
